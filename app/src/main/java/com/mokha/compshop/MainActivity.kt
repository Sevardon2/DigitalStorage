    ...
    override fun onClick(v: View) {
        when (v.getId()) {
            R.id.save -> {
                ...
                val getJenis: String = jenis.getText().toString()
                val getJumlah: String = jumlah.getText().toString()
                ...
                if (isEmpty(getNama) || isEmpty(getJenis) || isEmpty(getJumlah)) {
                    ...
                    getReference.child("Admin").child(getUserID).child("DataComputer").push()
                        .setValue(data_comp(getNama, getJenis, getJumlah))
